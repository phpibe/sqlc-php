...
class ParamResolver
{
    ...
    public function resolve(string $sql, array $annotations = []): array
    {
        ...
        // Strip internal rewriter tokens — :name_chk is the null-check companion
        // generated by SqlRewriter for @optional params. It must never surface as
        // a method parameter; it is always bound alongside its base param.
        $rawParams = array_values(array_filter(
            $rawParams,
            fn(string $t) => !str_ends_with($t, '_chk')
        ));
